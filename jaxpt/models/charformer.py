...
class AttentionBlock(nnx.Module): 
    ...
    def __init__(self, features, num_heads, block_size, rngs: nnx.Rngs):
        ...
        self.heads = [Head(head_size=features // num_heads, features=features, block_size=block_size, rngs=rngs) for _ in range(num_heads)]
...
class Charformer(nnx.Module):
    ...
    def __init__(self, vocab_size, features, num_heads, num_blocks, block_size, rngs: nnx.Rngs):
        ...
        self.blocks = [AttentionBlock(features, num_heads, block_size, rngs=rngs) for _ in range(num_blocks)]
